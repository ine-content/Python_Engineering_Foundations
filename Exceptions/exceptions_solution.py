# exceptions_solution.py
# Python Exceptions — Your Solution File
# Cisco IaC Perspective
#
# HOW TO USE:
# 1. Write your function for each task below
# 2. Run exceptions_grading.py to check your answers:
#    python3 exceptions_grading.py
...
# Task 1 — Catch a KeyError when accessing device fields


# Task 2 — Catch a TypeError when processing bad input


# Task 3 — Use try/except/else/finally


# Task 4 — Raise a ValueError for invalid device status


# Task 5 — Define and raise a custom exception


# Task 6 — Catch multiple exception types


# Task 7 — Process a batch with exception handling and summary


# Task 8 — Build a safe JSON parser with chained exceptions